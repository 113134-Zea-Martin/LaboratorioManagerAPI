...
{
    public class PutExperimentoDtoValidator : AbstractValidator<PutExperimentoDto>
    {
        public PutExperimentoDtoValidator()
        {
            ...
            RuleFor(x => x.Activo)
                ...
                .WithMessage("Debe ingresar un estado válido.");
        }
    }
}